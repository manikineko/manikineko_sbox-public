...
public partial class PhysGun : Carriable
{
	...
	public override void Spawn()
	{
		...
		Tags.Add( "weapon" );
		/*
		 	Model.Load( "models/weapon/builderwand.vmdl" );
		SetModel( "models/weapon/builderwand.vmdl" );
		 */
	...
	{
		if ( Owner is not MMOPlayer owner ) return;
	...
	private void TryStartGrab( Vector3 eyePos, Rotation eyeRot, Vector3 eyeDir )
	{
		...
		//
		if ( body.BodyType == PhysicsBodyType.Keyframed && rootEnt is not MMOPlayer )
			return;
	...
	private void GrabMove( Vector3 startPos, Vector3 dir, Rotation rot, bool snapAngles )
	{
		...
		if ( GrabbedEntity is MMOPlayer player )
		{
