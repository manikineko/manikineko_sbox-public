...
[Spawnable]
[Library( "weapon_moonsword", Title = "Katana MoonSword" )]
partial class MoonSword : Weapon
{
	...
	public override void Spawn()
	{
		...
		Model.Load( "models/weapon/katana_moonsword.vmdl" );
		SetModel( "models/weapon/katana_moonsword.vmdl" );
	}
	...
	private bool MeleeAttack()
	{
		...
		foreach ( var tr in TraceMelee( ray.Position, ray.Position + forward * 80, 20.0f ) )
		{
			...
			{
				var damageInfo = DamageInfo.FromBullet( tr.EndPosition, forward * 100, 50 )
					.UsingTraceResult( tr )
					.WithAttacker( Owner )
					.WithWeapon( this );
