...
[Spawnable]
[Library( "weapon_spamfists", Title = "Fists of Spamming" )]
partial class SpamFists : Weapon
{
	public override string ViewModelPath => "models/first_person/first_person_arms.vmdl";
	public override float PrimaryRate => 999999999.0f;
	public override float SecondaryRate => 999999999.0f;
	public override AzuruAnimationHelper.HoldTypes HoldType { get; set; } = AzuruAnimationHelper.HoldTypes.Punch;
