...
using Sandbox;
namespace Manikineko.MMO.Core.AnimHelpers
{
using System;
...
namespace Sandbox
{
	...
	/// </summary>
	public struct AzuruAnimationHelper
	{
		AnimatedEntity Owner;

		public AzuruAnimationHelper( AnimatedEntity entity )
		{
			Owner = entity;
		}
		...
		{
				get => Owner.GetAnimParameterBool( "b_attack" );
				set => Owner.SetAnimParameter( "b_attack", value );
			}
